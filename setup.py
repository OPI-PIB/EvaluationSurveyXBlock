#!/usr/bin/env python
"""
Package metadata for evaluation_survey.
"""
import os
import re
import sys
...
VERSION = get_version('evaluation_survey', '__init__.py')
...
setup(
    name='EvaluationSurveyXBlock',
    version=VERSION,
    description="""Evaluation Survey XBlock""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/edx/EvaluationSurveyXBlock',
    packages=[
        'evaluation_survey',
    ],
