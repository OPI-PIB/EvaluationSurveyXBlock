...
"""
EvaluationSurveyXBlock documentation build configuration file.
...
project = 'EvaluationSurveyXBlock'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'EvaluationSurveyXBlock'
...
html_context = {
    ...
    "github_repo": 'EvaluationSurveyXBlock',  # Repo name
...
#
# html_title = 'EvaluationSurveyXBlock v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Evaluation Survey XBlock',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'evaluation_survey'),
                os.path.join(root_path, 'evaluation_survey/migrations')])
